...
export default async function DetalleTareaAsignadaPage({ params }: PageProps) {
  ...
  return (
    <main className="p-8">
      ...
      <div className="bg-card rounded-[var(--radius-base)] border border-white shadow-sm p-8 max-w-3xl mx-auto mt-6">
        <h3 className="text-lg font-bold text-text mb-4">Asignaciones ({tarea.asignaciones.length})</h3>
