  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-card rounded-[var(--radius-base)] border border-white shadow-xl p-8 max-w-md w-full mx-4">
        <h3 className="flex justify-center text-xl font-bold text-text mb-4">Confirmar Cambio de Estado</h3>

        <p className="text-text/70 mb-2 text-center">
          Se marcará la tarea del  <strong className="text-text">{titulo}</strong> como{" "}
